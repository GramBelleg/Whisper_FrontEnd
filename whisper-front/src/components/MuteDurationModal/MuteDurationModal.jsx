            ...
            <div className="mute-duration-modal">
                ...
                <div className="radio-option">
                    <input
                        ...
                        onChange={(e) => {setMuteDuration(24); setSelectedDuration(24)}}
                    />
                ...
                <div className="radio-option">
                    <input
                        ...
                        onChange={(e) => { setMuteDuration(8); setSelectedDuration(8)}}
                    />
                ...
                <div className="radio-option">
                    <input
                        ...
                        onChange={(e) => { setMuteDuration(1); setSelectedDuration(1)}}
                    />
                    <label htmlFor="1-month">1 Month</label>
                </div>
                <div className="modal-buttons">
                    <button className="mute-button" onClick={() => {setClicked(true); onClose()}}>
                        Mute
                    </button>
