...
const ChatPage = () => {
    ...
    const chatList = [
        ...
        {name:"Amr Mahmoud", profile_pic:"./assets/images/Real_Madrid_CF.png",  message:"https://server11.mp3quran.net/yasser/001.mp3",message_state:"read", muted: false,  last_seen: "12:00", unread_notifications: 0, message_time:"2024-10-10 06:50:21", message_type:"audio"},
        ...
        {name:"Hana Mostafa", profile_pic:"./assets/images/ronaldo.jpeg",  message:"Ronaldo 2023",message_state:"read", muted: false,  last_seen: "12:00", unread_notifications: 0, message_time:"2024-10-12 05:50:50", message_type:"text"},
