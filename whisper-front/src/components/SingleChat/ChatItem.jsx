                    ...
                    <div className='content'>
                        <div className='user-info'>
                            ...
                            <div className='ticks-info'>
                                <div className='tick'>
                                    {(myChat.message_state === 0 && <SentTicks width='12px' />) ||
                                        (myChat.message_state == 1 && <DeliveredTicks />) ||
                                        (myChat.message_state == 2 && <ReadTicks />)}
                                </div>
                                <div className='message-time'>{myChat.display_time}</div>
                            </div>
                        </div>
                        <div className='messaging-info'>
                            <LastMessage
                                messageType={myChat.message_type}
                                message={myChat.message}
                                index={index}
                                messageState={myChat.message_state}
                            />
                        </div>
                    </div>
                </div>
