...
const ResetPassword = ({ handleChange, handleSubmit, handleBlur, values, errors, touched, isSubmitting, loading, error, handleClose }) => {
    const inputFields = [
    ...
    return (
        <div className='min-h-screen flex justify-center items-center bg-dark'>
            <div className='form-container w-full max-w-md p-8 bg-light rounded-lg shadow-md'>
                <button onClick={handleClose} className='text-xl text-gray-500 hover:text-gray-700 focus:outline-none' id='close-reset-btn'>
                    &times;
                </button>
                <h1 className='text-primary text-2xl font-bold mb-6 text-center'>Reset Password</h1>
