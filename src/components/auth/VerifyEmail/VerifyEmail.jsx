    ...
    return (
        <div className='flex flex-col justify-center items-center min-h-screen p-4'>
            <div className='w-full max-w-md mx-auto flex flex-col items-center justify-between p-4 bg-white rounded-lg shadow-md'>
                <h1 className='text-xl font-semibold text-center text-primary mb-4'>Account Verification</h1>
                ...
                {!canResend && <ResendTimer timer={timer} id='resend-verify-timer' />}

                <h3 className='text-lg font-medium text-primary mb-4 text-center'>Please Enter Verification Code</h3>
                <div className='w-4/5'>
                    <CustomInput
                        type='password'
                        id='code'
